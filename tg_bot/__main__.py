...
TECHNO_IMG = "https://telegra.ph/SAKURA-GROUP-HELP-BOT-11-10"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/anshumandhariwal")],
                                                                                   [InlineKeyboardButton(text="ADD SAKURA TO YOUR GROUP",
        ...
        update.effective_message.reply_text("SAKURA IS ALWAYS ONLINE HUH!💯")
